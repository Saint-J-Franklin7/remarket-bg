...
export const metadata: Metadata = {
  ...
  description: 'Качествени продукти на достъпна цена. Поръчайте онлайн, доставяме с Еконт, Спиди и Pigeon Express до всяка точка в България. Плащане при получаване.',
